...
<div class="main-content">
    <div class="main-content-top">
        <div class="breadcrumb">
            <ul class="clearfix">
                ...
                <li><a href="<?= ADMIN_URL ?>?page=language_var_list" title="Language Variable Management">Language Variable Management</a><img src="../images/theme_images/bcarrow.png" alt="arrow" /></li>
    ...
    <div class="main-container">
        ...
        <div class="grid-data grid-data-table">
            ...
            <div class="add-new"><a href="<?= ADMIN_URL ?>?page=add_language_var" title="Add New Language Variable">Add New Language Variable</a></div>
            <table cellspacing="1" cellpadding="4" border="0" bgcolor="#e6ecf2" width="100%">
                ...
                $i++ ?></td>
                        ...
                        <td>
                            <div class="action">
                                <div class="edit"><a href="<?= ADMIN_URL ?>?page=add_language_var&action=edit&id=<?php echo $_categories['id']; ?>" title="Edit"><img src="../images/theme_images/edit.png" alt="Edit" /></a></div>
                                <div class="delete">
