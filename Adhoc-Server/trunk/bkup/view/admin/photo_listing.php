...
window.location = "<?= ADMIN_URL?>?page=add_photo&action=statusupdate&status="+statusVal+"&id="+commentId;
return true;
                    	...
                    	<div class="main-content-top">
                            <div class="breadcrumb">
                                <ul class="clearfix">
                                  ...
                                  <li><a href="<?= ADMIN_URL ?>?page=photo_listing" title="Product Management">Photo Management</a><img src="../images/theme_images/bcarrow.png" alt="arrow" /></li>
                                    <li>List Photo</li>
                                </ul>
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select class="txtwidth3" name="search" id="search" >
                                                        ...
                                                        <option value="2" <? if ($_REQUEST['search'] == 2) echo"selected" ?> title="username" ><?php  echo "Username"?></option>
                                                    </select>
                                                </td>
                                        ...
                                        <tr class="odd-row">
                                            ...
                                            <td><?php echo $photos['name'] ?> </td>
                                                <td align="center" style="text-align: center;">
                            				        <?php if( $photos['image'] == '' ) { ?>
                            				         <img align="left" src="<?=SITE_URL?>timthumb.php?src=<?php echo ADMIN_IMAGE_URL.'default_image.gif'; ?>&h=80&w=80&q=100" alt="" >
                            				        <?php } else { ?>
                            				         <img align="left"	src="<?=SITE_URL?>timthumb.php?src=<?php echo PHOTO_IMAGE_URL.$photos['image']; ?>&h=80&w=80&q=100"  alt="" >
                            				         <?php } ?>
                            				    </td>
                                                <td>
                                                    <?php
                                            ...
                                            <td>
                                            	<div class="action">
                                                 ...
                                                 <?php
                                                	...
                                                	<div class="edit"><a href="<?= ADMIN_URL?>?page=add_photo&action=edit&id=<?php echo $photos['id'];?><?php echo $etvars?>" title="Edit"><img src="../images/theme_images/edit.png" alt="Edit" /></a></div>
                                                    <!--<div class="delete"><a href="#" title="Delete"><img src="../images/theme_images/delete.png" alt="Delete" /></a></div>-->
                                                    <div class="delete"><a onclick="return confirm('Are you sure you want to delete?')" href="<?= ADMIN_URL?>?page=photo_listing&action=delete&id=<?php echo $photos['id'] ?>" title="Delete"><img src="../images/theme_images/delete.png" alt="Delete" /></a></div>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php }?>
