  ...
  <form name="addEditPhoto" id="addEditPhoto" method="post" enctype="multipart/form-data">
            <div class="main-content">
                    ...
                    <div class="main-container">
                        	<div class="grid-data">
                            	<div class="add-new"><a href="<?= ADMIN_URL ?>?page=tag_listing" title="View All Users">View All Tag</a></div>
                                <table cellspacing="1" cellpadding="4" border="0" bgcolor="#e6ecf2" width="100%">
                                    ...
                                    <td ><input name="name" class="validate[required]" value="<? if ($_REQUEST['name'] != "") echo $_REQUEST['name']; else echo $tag['name']; ?>" type="text" id="name" size="35" maxlength="100"  /></td>
                                </tr>
                                <!--<tr>
                                    ...
                                    <td >
                                        ...
                                        <option value="<?php echo $d['id']; ?>" <? if ($_REQUEST['user_id'] == $d['id'])echo "selected"; elseif ($photo['user_id'] == $d['id']) echo "selected"; ?> ><?php echo $d['user_name']; ?></option>
                                        <?php } ?>
                                        </select>
                                    </td>
                                </tr>-->
                                ...
                                <tr>
                                    ...
                                    <td >
                                        <select  class="txtwidth" name='status' id='status'>
                                            <option   value="Active" <? if ($_REQUEST['status'] == 'Active')echo "selected"; elseif ($tag['status'] == 'Active') echo "selected"; ?> ><?php  echo "Active"?></option>
                                            <option  value="Inactive" <? if ($_REQUEST['status'] == 'Inactive') echo "selected"; elseif ($tag['status'] == 'Inactive') echo "selected"; ?>><?php  echo "Inactive"?></option>
                                        </select>
                                    </td>
                                </tr>
