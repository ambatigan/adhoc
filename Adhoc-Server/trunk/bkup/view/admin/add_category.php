        ...
        $(".close").click(function(){
            ...
            <div class="main-content">
                    ...
                    <div class="main-container">
                        	<div class="grid-data">
                            	<div class="add-new"><a href="<?= ADMIN_URL ?>?page=category_list" title="View All Categories">View All Categories</a></div>
                                                  	...
                                                  	<tr>
                                                        ...
                                                        <td>
                                                           <select id="status" name="status" style="width:208px;" tabindex="2">
                                                               <option <?=($objCategory->status == 'A')?'selected="selected"':''?> value="A">Active</option>
                                                               <option <?=($objCategory->status == 'I')?'selected="selected"':''?> value="I">Inactive</option>
                                                           </select>
                                                    	</td>
                                                    </tr>
