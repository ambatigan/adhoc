...
window.location = "<?= ADMIN_URL?>?page=add_comment&action=statusupdate&status="+statusVal+"&id="+commentId;
return true;
                    	...
                    	<div class="main-content-top">
                            <div class="breadcrumb">
                                <ul class="clearfix">
                                  ...
                                  <li><a href="<?= ADMIN_URL ?>?page=comment_listing" title="Product Management">Comment Management</a><img src="../images/theme_images/bcarrow.png" alt="arrow" /></li>
                                    <li>Comment List</li>
                                </ul>
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select class="txtwidth3" name="search" id="search" >
                                                        ...
                                                        <option value="2" <? if ($_REQUEST['search'] == 2) echo"selected" ?> title="Comment" ><?php  echo "Comment"?></option>
                                                    </select>
                                                </td>
                                            ...
                                            <td>
                                            	<div class="action">
                                                 ...
                                                 <?php
                                                	...
                                                	<div class="edit"><a href="<?= ADMIN_URL?>?page=add_comment&action=edit&id=<?php echo $comments['id'];?><?php echo $etvars?>" title="Edit"><img src="../images/theme_images/edit.png" alt="Edit" /></a></div>
                                                    <!--<div class="delete"><a href="#" title="Delete"><img src="../images/theme_images/delete.png" alt="Delete" /></a></div>-->
                                                    <div class="delete"><a onclick="return confirm('Are you sure you want to delete?')" href="<?= ADMIN_URL?>?page=comment_listing&action=delete&id=<?php echo $comments['id'] ?>" title="Delete"><img src="../images/theme_images/delete.png" alt="Delete" /></a></div>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php }?>
