  ...
  <form name="addEditUser" id="addEditUser" method="post" enctype="multipart/form-data">
            <div class="main-content">
                    ...
                    <div class="main-container">
                        	<div class="grid-data">
                            	<div class="add-new"><a href="<?= ADMIN_URL ?>?page=users_listing" title="View All Users">View All Users</a></div>
                                        	...
                                        	<td class="add-user-form-box">
                                            	<table width="100%" cellpadding="5" cellspacing="1" border="0">
                                                 <tr>
                                                    ...
                                                    <td><input name="user_name" class="validate[required]" value="<? if ($_REQUEST['user_name'] != "") echo $_REQUEST['user_name']; else echo $user['user_name']; ?>" type="text" id="username" style="width:198px;" tabindex="1" maxlength="35"  /></td>
                                                </tr>
                                                 <tr>
                                ...
                                <tr>
                                    ...
                                    <td><input name="password" class="<? echo $class; ?>" value="" type="password" id="password" style="width:198px;" tabindex="2" maxlength="35"   />
                                        <? if ($objUser->id != '' && $action == 'edit') { ?><br /><? echo "Keep password and confirm password blank if you don't want to change.";} ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="135" align="right" ><?php if($action == 'add'){ ?><span class="star">*&nbsp;</span><?php } ?><?php  echo "Confirm Password"?>:</td>
                                    <td><input type="password" class="<? echo $class1; ?>" name="confirmpassword" value="" id="confirmpassword" style="width:198px;" tabindex="3" maxlength="35"   /></td>
                                </tr>
                                <tr>
                                    <td align="right" ><?php  echo "First Name" ?>:</td>
                                    <td><input name="first_name" maxlength="50" value="<? if ($_REQUEST['first_name'] != "") echo $_REQUEST['first_name']; else echo $user['first_name']; ?>" type="text" id="firstname" style="width:198px;" tabindex="4"  /></td>
                                </tr>
                                <tr>
                                    <td align="right" ><?php  echo "Last Name" ?> :</td>
                                    <td><input  name="last_name" maxlength="30" value="<? if ($_REQUEST['last_name'] != "") echo $_REQUEST['last_name']; else echo $user['last_name']; ?>" type="text" id="lastname" style="width:198px;" tabindex="5"   /></td>
                                </tr>
                                 <tr>
                                    <td align="right" ><span class="star">*&nbsp;</span><?php  echo "Email Address"?>:</td>
                                    <td><input name="email" maxlength="50" class="validate[required,custom[email]]" value="<? if ($_REQUEST['email'] != "") echo $_REQUEST['email']; else echo $user['email']; ?>" type="text" id="email" style="width:198px;" tabindex="6"   /></td>
                                </tr>
                                    <?php  if($action =='edit') { ?>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                        ...
                                        <img src="<?=SITE_URL?>timthumb.php?src=<?php echo USER_IMAGE_URL.$user['image']?>&h=160&w=160&q=100" alt="">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select  class="txtwidth" name='status' id='status'>
                                            <option  value="Active" <? if ($_REQUEST['status'] == 'Active')echo "selected"; elseif ($user['status'] == 'Active') echo "selected"; ?> ><?php  echo "Unblock"?></option>
                                            <option  value="Inactive" <? if ($_REQUEST['status'] == 'Inactive') echo "selected"; elseif ($user['status'] == 'Inactive') echo "selected"; ?>><?php  echo "Blocked"?></option>
                                        </select>
                                    </td>
                                </tr>
