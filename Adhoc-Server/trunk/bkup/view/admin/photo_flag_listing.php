                    	...
                    	<div class="main-content-top">
                            <div class="breadcrumb">
                                <ul class="clearfix">
                                  ...
                                  <li><a href="<?= ADMIN_URL ?>?page=photo_flag_listing" title="Product Management">Photo Flag Management</a><img src="../images/theme_images/bcarrow.png" alt="arrow" /></li>
                                    ...
                                    <?php foreach ($photo_flag as $photo_flags){ ?>
                                        <tr class="odd-row">
                                            ...
                                            <td align="center" style="text-align: center;">
                        				        ...
                        				        <?php } else { ?>
                        				         <img align="left"	src="<?=SITE_URL?>timthumb.php?src=<?php echo PHOTO_URL.$photo_flags['image']; ?>&h=80&w=80&q=100"  alt="" >
                        				         <?php } ?>
                        				    </td>
                                            <td>
                                                <?php
                                            ...
                                            <td>
                                            	<div class="action">
                                                 ...
                                                 <?php
                                                   ...
                                                   <?php if( $photo_flags['flag'] == 'Active' ) { ?>
                                                         <center><a href="./?page=photo_flag_listing&action=edit&id=<?php echo $photo_flags['id'] ?><?php echo $etvars?>" title="Remove Flag">
