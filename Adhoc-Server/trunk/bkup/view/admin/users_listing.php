...
window.location = "<?= ADMIN_URL?>?page=add_user&action=statusupdate&status="+statusVal+"&id="+commentId;
return true;
                    	...
                    	<div class="main-content-top">
                            <div class="breadcrumb">
                                <ul class="clearfix">
                                  ...
                                  <li><a href="<?= ADMIN_URL ?>?page=users_listing" title="User Management">User Management</a><img src="../images/theme_images/bcarrow.png" alt="arrow" /></li>
                                    <li>User List</li>
                                </ul>
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select class="txtwidth3" name="search" id="search" >
                                                        <option value="1" <? if ($_REQUEST['search'] == 1) echo"selected" ?> title="username" ><?php  echo "Username"?></option>
                                                        <option value="2" <? if ($_REQUEST['search'] == 2) echo"selected" ?> title="email" ><?php  echo "Email Address"?></option>
                                                    </select>
                                                </td>
                                            ...
                                            <td>
                                            	<div class="action">
                                                 ...
                                                 <?php
                                                	...
                                                	<div class="edit"><a href="<?= ADMIN_URL?>?page=add_user&action=edit&id=<?php echo $users['id'];?><?php echo $etvars?>" title="Edit"><img src="../images/theme_images/edit.png" alt="Edit" /></a></div>
                                                    <!--<div class="delete"><a href="#" title="Delete"><img src="../images/theme_images/delete.png" alt="Delete" /></a></div>-->
                                                    <div class="delete"><a onclick="return confirm('Are you sure you want to delete?')" href="<?= ADMIN_URL?>?page=users_listing&action=delete&id=<?php echo $users['id'] ?>" title="Delete"><img src="../images/theme_images/delete.png" alt="Delete" /></a></div>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php }?>
