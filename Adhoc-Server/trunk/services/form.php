	   ...
	   /****************************************************************/
        ...
        /****************************************************************/
		 ...
		 /****************************************************************/
          ...
          /****************************************************************/
  		/********************** Delete User's Advertisement ****************************/
  		/****************************************************************/
    
            $('#btn_form_deleteuseradvertisement').click(function(){
		 	var json_body="{\"user_id\":\""+$('#deleteuseradvertisement_user_id').val()+"\",\"photo_id\":\""+$('#deleteuseradvertisement_photo_id').val()+"\"}";
		    var json_header="{\"name\":\"DeleteUserAdvertisement\",\"body\":"+json_body+"}";
				...
				$.ajax({
				  ...
				  success: function(response)
                  {
				    $('#req_btn_form_deleteuseradvertisement').html(json_header);
				    $('#res_btn_form_deleteuseradvertisement').html(response);
				  }
				});
		 });
		 ...
		 /****************************************************************/
          ...
          /****************************************************************/
  		/********************** User's list who liked this Advertisement **********/
  		/****************************************************************/
    
            $('#btn_form_listofuserlikeadvertisement').click(function(){
		 	var json_body="{\"photo_id\":\""+$('#listofuserlikeadvertisement_photo_id').val()+"\"}";
		    var json_header="{\"name\":\"listofuserswholikedads\",\"body\":"+json_body+"}";
				...
				$.ajax({
				  ...
				  success: function(response)
                  {
				    $('#req_btn_form_listofuserlikeadvertisement').html(json_header);
				    $('#res_btn_form_listofuserlikeadvertisement').html(response);
				  }
				});
		 });

/****************************************************************/
  		/********************** Get Universal Prompt Message ****************************/
  		/****************************************************************/

            $('#btn_form_prompt_msg').click(function(){
            	var json_header="{\"name\":\"GetPromptMsg\"}";
				...
				$.ajax({
				  ...
				  success: function(response)
                  {
				    $('#req_btn_form_prompt_msg').html(json_header);
				    $('#res_btn_form_prompt_msg').html(response);
				  }
				});
		 });
		 /****************************************************************/
...
<!------------------------------------------------------------------------------------------------------------------------------------------>
        ...
        <!------------------------------------------------------------------------------------------------------------------------------------------>
         ...
         <div class="fl w500 box">
			...
			<form name="form_deleteuseradvertisement" id="form_deleteuseradvertisement">
				<div class="header">Delete User's Advertisement</div>
				<div class="cont">
                    
					<div style="font-weight: bold">User id</div>
					<div><input type="text" id="deleteuseradvertisement_user_id" name="deleteuseradvertisement_user_id" /></div>
                    
                    <div style="font-weight: bold">Photo id</div>
					<div><input type="text" id="deleteuseradvertisement_photo_id" name="deleteuseradvertisement_photo_id" /></div>
                  
					<div class="reqcap">Request</div>
					<textarea class="reqT" id="req_btn_form_deleteuseradvertisement" name="req_btn_form_deleteuseradvertisement" rows="5" cols="58"></textarea>
					<div class="rescap">Response</div>
					<textarea class="resT" id="res_btn_form_deleteuseradvertisement" name="res_btn_form_deleteuseradvertisement" rows="5" cols="58"></textarea>
					<div class="btn">
						<input type="button" id="btn_form_deleteuseradvertisement" name="btn_form_deleteuseradvertisement" value="Execute" />
					</div>
				</div>
			</form>
		</div>
        ...
        <div class="fl w500 box">
			...
			<form name="form_listofuserlikeadvertisement" id="form_listofuserlikeadvertisement">
				<div class="header">List of Users Who Liked This Advertisement</div>
				<div class="cont">
                    
					<div style="font-weight: bold">Photo id</div>
					<div><input type="text" id="listofuserlikeadvertisement_photo_id" name="listofuserlikeadvertisement_photo_id" /></div>
                  
					<div class="reqcap">Request</div>
					<textarea class="reqT" id="req_btn_form_listofuserlikeadvertisement" name="req_btn_form_listofuserlikeadvertisement" rows="5" cols="58"></textarea>
					<div class="rescap">Response</div>
					<textarea class="resT" id="res_btn_form_listofuserlikeadvertisement" name="res_btn_form_listofuserlikeadvertisement" rows="5" cols="58"></textarea>
					<div class="btn">
						<input type="button" id="btn_form_listofuserlikeadvertisement" name="btn_form_listofuserlikeadvertisement" value="Execute" />
					</div>
				</div>
			</form>
		</div>
    	...
    	<div class="fl w500 box">
			...
			<form name="form_comment_list" id="form_prompt_msg">
				<div class="header">Get Prompt Message</div>
				<div class="cont">
                <div class="reqcap">Request</div>
					<textarea class="reqT" id="req_btn_form_prompt_msg" name="req_btn_form_prompt_msg" rows="5" cols="58"></textarea>
					<div class="rescap">Response</div>
					<textarea class="resT" id="res_btn_form_prompt_msg" name="res_btn_form_prompt_msg" rows="5" cols="58"></textarea>
					<div class="btn">
						<input type="button" id="btn_form_prompt_msg" name="btn_form_prompt_msg" value="Execute" />
					</div>
				</div>
			</form>
		</div>
