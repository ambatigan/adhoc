...
<form name="add_language_var" id="add_language_var" method="post">
    <div class="main-content">
        ...
        <div class="main-container">
            <div class="grid-data">
                <div class="add-new"><a href="<?php echo  ADMIN_URL ?>?page=language_var_list" title="View All Language Var">View All Language Variable</a></div>
                            ...
                            <td class="add-user-form-box">
                                <table width="100%" cellpadding="5" cellspacing="1" border="0">
                                    <tr>
                                        ...
                                        <td>
<!--                                            <b><?php echo  $obj_language_var['name']; ?></b>-->
                                            <input type="text" value="<?php echo  $obj_language_var['name']; ?>" class="validate[required]" name="name" style="width:198px;" tabindex="1" >
<!--                                            <input type="hidden" value="<?php echo  $obj_language_var['name']; ?>" class="validate[required]" name="name" style="width:198px;" tabindex="1" >-->
                                        </td>
