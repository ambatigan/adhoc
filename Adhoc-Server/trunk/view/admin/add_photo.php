  ...
  <form name="addEditPhoto" id="addEditPhoto" method="post" enctype="multipart/form-data">
            <div class="main-content">
                    ...
                    <div class="main-container">
                        	<div class="grid-data">
                            	<div class="add-new"><a href="<?php echo  ADMIN_URL ?>?page=photo_listing" title="View All Users">View All Photo</a></div>
                                <table cellspacing="1" cellpadding="4" border="0" bgcolor="#e6ecf2" width="100%">
                                	<tbody bgcolor="#fff">
                                        ...
                                        <tr>
                                            ...
                                            <td ><input name="name" class="validate[required]" value="<?php if ($_REQUEST['name'] != "") echo $_REQUEST['name']; else echo $photo['name']; ?>" type="text" id="name" size="35" maxlength="100"  /></td>
                                        </tr>
                                ...
                                <?php  if($action =='edit') { ?>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                        ...
                                        <img src="<?php echo PHOTO_IMAGE_URL.$photo['image']?>" width="160" height="160" alt="">
                                ...
                                <tr>
                                    ...
                                    <td >
                                        <select  class="txtwidth" name='status' id='status'>
                                            <option   value="Active" <?php if ($_REQUEST['status'] == 'Active')echo "selected"; elseif ($photo['status'] == 'Active') echo "selected"; ?> ><?php  echo "Active"?></option>
                                            <option  value="Inactive" <?php if ($_REQUEST['status'] == 'Inactive') echo "selected"; elseif ($photo['status'] == 'Inactive') echo "selected"; ?>><?php  echo "Inactive"?></option>
                                        </select>
                                    </td>
                                </tr>
