                          ...
                          <tr>
                           <td valign="top" class="admcontentpadd">
                            <table  border="0" cellspacing="1" cellpadding="4" >
                             ...
                             <tr>
	                		<td><b><?php //echo index_lang::$Search;?>:</b></td>
	                		...
	                		<td class="sbut" valign="top">
	                			...
	                			<input name="Search<?php //echo index_lang::$Search;?>" type="submit"  class="inputbutton"  value="Search<?php //echo index_lang::$Search;?>" title="Search<?php //echo index_lang::$Search;?>"  />
							</td>
                                                ...
                                                ?>
                                                            <tr>
                                                                <td valign="top" align="center" colspan="4">
                                                                    <span class="redlabel"><?php echo  index_lang::$no_items ?></span>
                                                                </td>
                                                            </tr>
                                                <?php
                                                        }
                                                            ...
                                                            foreach ($objlanguage as $k => $d) {
                                                                ...
                                                                <tr class="<?php echo $cls ?>" >
                    												...
                    												<td align="center" width="10%">
                    													<a href="./?page=add_language&action=edit&id=<?php echo $d['id'] ?>" title="<?php echo index_lang::$edit?>"><img src="<?php echo ADMIN_IMAGE_URL ?>edit.png"  alt="<?php echo index_lang::$edit?>" border="0" /></a>&nbsp;&nbsp;
                                                                        <?php if($d['set_default'] == 1){ ?>
                                                                         <a onclick="return alert('Cannot delete language, it is set as default.')" href="" title="<?php echo index_lang::$delete?>"><img src="<?php echo ADMIN_IMAGE_URL ?>delete.png" alt="<?php echo index_lang::$delete?>" border="0" /></a>
                                                                        <?php } else {?>
                                                                        <a onclick="return confirm('<?php echo index_lang::$suredelete;?>')" href="./?page=language_list&action=delete&id=<?php echo $d['id'] ?>" title="<?php echo index_lang::$delete?>"><img src="<?php echo ADMIN_IMAGE_URL ?>delete.png" alt="<?php echo index_lang::$delete?>" border="0" /></a>
                                                                        <?php } ?>
                    												</td>
                                                                </tr>
                                                        <?php }
                    ...
                    <?php if(!empty($objlanguage)) { ?>
					   	<tr style="border-left: none;">
							<td align="right" class="manu" style="border-left: none;" >
							 <?php echo index_lang::$showing?> <?php echo $starting_record ?> <?php echo index_lang::$to?> <?php echo $ending_record ?> <?php echo index_lang::$of ?>&nbsp;<?php echo $total_records ?>&nbsp;&nbsp;
                            <?php echo $pagging ?></td>
					   	</tr>
				   <?php } ?>
                </table>
