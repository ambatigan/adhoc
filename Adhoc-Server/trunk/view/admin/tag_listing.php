...
window.location = "<?php echo  ADMIN_URL?>?page=add_tag&action=statusupdate&status="+statusVal+"&id="+commentId;
return true;
                    	...
                    	<div class="main-content-top">
                            <div class="breadcrumb">
                                <ul class="clearfix">
                                  ...
                                  <li><a href="<?php echo  ADMIN_URL ?>?page=tag_listing" title="Product Management">Tag Management</a><img src="../images/theme_images/bcarrow.png" alt="arrow" /></li>
                                    <li>List Tag</li>
                                </ul>
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select class="txtwidth3" name="search" id="search" >
                                                        ...
                                                        <!--<option value="2" <?php if ($_REQUEST['search'] == 2) echo"selected" ?> title="photo name" ><?php  echo "Photo Name"?></option>-->
                                                        <option value="3" <?php if ($_REQUEST['search'] == 3) echo"selected" ?> title="user name" ><?php  echo "User Name"?></option>
                                                    </select>
                                                </td>
                                            ...
                                            <td>
                                            	<div class="action">
                                                 ...
                                                 <?php
                                                	...
                                                	<div class="edit"><a href="<?php echo  ADMIN_URL?>?page=add_tag&action=edit&id=<?php echo $tags['id'];?><?php echo $etvars?>" title="Edit"><img src="../images/theme_images/edit.png" alt="Edit" /></a></div>
                                                    <!--<div class="delete"><a href="#" title="Delete"><img src="../images/theme_images/delete.png" alt="Delete" /></a></div>-->
                                                    <div class="delete"><a onclick="return confirm('Are you sure you want to delete?')" href="<?php echo  ADMIN_URL?>?page=tag_listing&action=delete&id=<?php echo $tags['id'] ?>" title="Delete"><img src="../images/theme_images/delete.png" alt="Delete" /></a></div>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php }?>
