...
<form name="add_language" id="add_language" method="post" enctype="multipart/form-data">
            ...
            <td>
                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                      ...
                      <tr>
                          <td class="admtitle"><?php echo $title;?></td>
    ...
    <table width="100%" cellspacing="4" cellpadding="2" border="0" class="tablebgcolor">
        ...
        <tr>
            ...
            <td>
                <input class="input validate[required]" id="language_name" name="language_name" tabindex="1" value="<?php echo $objlanguage['language_name']?>" maxlength="50" />
            </td>
        </tr>
		<tr>
            <td align="right"><span class="star">*&nbsp;</span><strong><?php echo index_lang::translate("Language Code");?> :</strong></td>
            <td>
                <input class="input validate[required]" id="lng_code" name="lng_code" tabindex="2" value="<?php echo $objlanguage['lng_code']?>" maxlength="2"/>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" onclick="setDefault(this.checked)" id="set_default" tabindex="4" <?php if($objlanguage['set_default'] == 1){?>checked="checked" disabled="disabled"<?php } ?> name="set_default" value="1"/>
            </td>
        </tr>
		<tr>
			<td></td>
    		<td class="campos2" valign="top"><input name="LanguageFormSubmit" id="LanguageFormSubmit" tabindex="5" type="submit"  class="subbut" value="<?php echo index_lang::translate("Submit");?>" title="<?php echo  index_lang::$submit ?>"  />&nbsp;&nbsp;
    		<input type="button" value="<?php echo index_lang::translate("Cancel");?>" title="<?php echo  index_lang::$cancel ?>" class="subbut" tabindex="6" onclick="javascript:cancelForm('?page=language_list&amp;action=view')" name="btnCancel">
    		</td>
  		</tr>
	</table>
    </td>
