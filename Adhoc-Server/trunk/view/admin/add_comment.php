  ...
  <form name="addEditComment" id="addEditComment" method="post" enctype="multipart/form-data">
            <div class="main-content">
                    ...
                    <div class="main-container">
                        	<div class="grid-data">
                            	<div class="add-new"><a href="<?php echo  ADMIN_URL ?>?page=comment_listing" title="View All Comment">View All Comment</a></div>
                                <table cellspacing="1" cellpadding="4" border="0" bgcolor="#e6ecf2" width="100%">
                                    ...
                                    <td class="fieldbg">
                                        <select  class="validate[required] txtwidth" name='photo_id' id='photo_id'>
                                            ...
                                            <option <?php if ($_REQUEST['id'] == $photo_id['id']){ echo "selected"; }else if ($comment['photo_id'] == $photo_id['id']){ echo "selected";} ?>  value ="<?php echo $photo_id['id']; ?>" ><?php echo $photo_id['name']; ?></option><?php }?>
                                        </select></td>
                                </tr>
                                <tr>
                                    <td align="right" ><strong><span class="star">*&nbsp;</span><?php echo "Comment"?>:</strong></td>
                                    <td class="fieldbg"><textarea name="comment" class="validate[required]" id="comment" rows="3" cols="30" ><?php if ($_REQUEST['comment'] != "") echo $_REQUEST['comment']; else echo $comment['comment']; ?></textarea> </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="fieldbg">
                                        <select  class="txtwidth" name='status' id='status'>
                                            <option   value="Active" <?php if ($_REQUEST['status'] == 'Active')echo "selected"; elseif ($comment['status'] == 'Active') echo "selected"; ?> ><?php  echo "Active"?></option>
                                            <option  value="Inactive" <?php if ($_REQUEST['status'] == 'Inactive') echo "selected"; elseif ($comment['status'] == 'Inactive') echo "selected"; ?>><?php  echo "Inactive"?></option>
                                        </select>
                                    </td>
                                </tr>
