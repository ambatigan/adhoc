                                            	...
                                            	<div class="action">
                                                 ...
                                                 <?php
                                                   ...
                                                   <?php }else {?>
                                                    ...
                                                    <div class="delete"><a onclick="return confirm('Are you sure you want to delete?')" href="<?= ADMIN_URL?>?page=photo_flag_listing&action=delete&id=<?php echo $photo_flags['id'] ?>" title="Delete"><img src="../images/theme_images/delete.png" alt="Delete" /></a></div>
