                                        ...
                                        <tr class="odd-row">
                                            ...
                                            <td align="center" style="text-align: center;">
                        				        <?php if( $photo_flags['image'] == '' ) { ?>
                        				         <img align="left" src="<?php echo SITE_URL?>timthumb.php?src=<?php echo ADMIN_IMAGE_URL.'default_image.gif'; ?>&h=80&w=80&q=100" alt="" >
                        				        <?php } else { ?>
                        				         <img align="left"	src="<?php echo SITE_URL?>timthumb.php?src=<?php echo PHOTO_URL.$photo_flags['image']; ?>&h=80&w=80&q=100"  alt="" >
                        				         <?php } ?>
                        				    </td>
                                            <td>
                                                <?php
