	   ...
	   /****************************************************************/
 		...
 		/****************************************************************/
           ...
           $('#btn_form_fb_registration').click(function(){
            ...
            var json_body="{\"firstname\":\""+$('#fname').val()+"\",\"lastname\":\""+$('#lname').val()+"\",\"emailid\":\""+$('#emailid').val()+"\",\"sex\":\""+$('#gender').val()+"\",\"birthdate\":\""+$('#bdate').val()+"\",\"profileimage\":\""+$('#image').val()+"\"}";
         ...
         /****************************************************************/
  		...
  		/****************************************************************/
            ...
            $('#btn_form_allphotos').click(function(){
		 	var json_body="{\"start\":\""+$('#start_record').val()+"\",\"total_record\":\""+$('#total_records').val()+"\",\"searchText\":\""+$('#search_text').val()+"\"}";
		...
		/****************************************************************/
  		...
  		/****************************************************************/
            ...
            $('#btn_form_addtoken').click(function(){
		 	var json_body="{\"token\":\""+$('#devicetoken').val()+"\"}"
		...
		/****************************************************************/
  		...
  		/****************************************************************/
			...
			var json_body="{\"userid\":\""+$('#update_user_id').val()+"\",\"username\":\""+$('#username').val()+"\",\"profile_image\":\""+$('#profile_image').val()+"\"}";
         ...
         /****************************************************************/
  		...
  		/****************************************************************/
			...
			var json_body="{\"Pid\":\""+$('#update_photo_photo_id').val()+"\",\"Caption\":\""+$('#update_photo_caption_name').val()+"\",\"ImageData\":\""+$('#profile_image').val()+"\",\"Tag\":\""+$('#update_photo_tag').val()+"\"}";
        ...
        $('#btn_form_photo_detail').click(function(){
		 ...
		 /****************************************************************/
  		...
  		/****************************************************************/
			...
			//var json_body="{\"Pid\":\""+$('#comment_list_photo_id').val()+"\"}";
		 	var json_header="{\"name\":\"GetPromptMsg\",\"body\":"+json_body+"}";
